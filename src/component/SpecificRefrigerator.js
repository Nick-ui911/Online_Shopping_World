...
import RefrigeratorData from './RefrigeratorData';
import useSpecificRefrigerator from '../utils/useSpecificRefrigerator';
import useRefrigerator from "../utils/useRefrigerator";


const SpecificRefrigerator = () => {
  
  const {id9} = useParams();
  const[item,error,loading] = useSpecificRefrigerator(id9);
      ...
      <div className="specific-item-container trending-container">
        ...
        <div className="right-section">
          ...
          <div className="action-buttons">
            <button onClick={() => addRefrigerator(item)} className="add-to-cart-btn">
              Add to Cart
            </button>
...
export default SpecificRefrigerator
