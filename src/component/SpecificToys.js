...
import useSpecificToys from "../utils/useSpecificToys";
import useToys from "../utils/useToys";

const SpecificToys = () => {

    const {id18} = useParams();
    const[item,error,loading] = useSpecificToys(id18);
        ...
        <div className="specific-item-container trending-container">
          ...
          <div className="right-section">
            ...
            <div className="action-buttons">
              <button onClick={() => addToys(item)} className="add-to-cart-btn">
                Add to Cart
              </button>
