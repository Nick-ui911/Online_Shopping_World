...
import useSpecificTVs from '../utils/useSpecificTVs'
...
import useTVs from "../utils/useTVs";
import TVsData from "./TVsData";


const SpecificTVs = () => {

  const {id7} = useParams();
  const[item,error,loading] = useSpecificTVs(id7);
      ...
      <div className="specific-item-container trending-container">
        ...
        <div className="right-section">
          ...
          <div className="action-buttons">
            <button onClick={() => addTVs(item)} className="add-to-cart-btn">
              Add to Cart
            </button>
