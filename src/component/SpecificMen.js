...
import useSpecificMen from '../utils/useSpecificMen';
import useMen from '../utils/useMen';
import MenData from './MenData';

const SpecificMen = () => {
    const {id15} = useParams();
    const[item,error,loading] = useSpecificMen(id15);
      ...
      <div className="specific-item-container trending-container">
        ...
        <div className="right-section">
          ...
          <div className="action-buttons">
            <button onClick={() => addMen(item)} className="add-to-cart-btn">
              Add to Cart
            </button>
