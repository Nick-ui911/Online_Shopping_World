...
import useSpecificBooks from '../utils/useSpecificBooks';

const SpecificBooks = () => {

    const {id19} = useParams();
    const[item,error,loading] = useSpecificBooks(id19);
        ...
        <div className="specific-item-container trending-container">
          ...
          <div className="right-section">
            ...
            <div className="action-buttons">
              <button onClick={() => addBooks(item)} className="add-to-cart-btn">
                Add to Cart
              </button>
