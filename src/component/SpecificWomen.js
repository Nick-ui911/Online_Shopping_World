...
import useSpecificWomen from '../utils/useSpecificWomen';
import useWomen from '../utils/useWomen';


const SpecificWomen = () => {
    const {id16} = useParams();
    const[item,error,loading] = useSpecificWomen(id16);
    const { seller } = useContext(UserContext);
    const dispatch = useDispatch();
    const [items] = useWomen()
      ...
      <div className="specific-item-container trending-container">
        ...
        <div className="right-section">
          ...
          <div className="action-buttons">
            <button onClick={() => addWomen(item)} className="add-to-cart-btn">
              Add to Cart
            </button>
