...
import useSpecificKids from '../utils/useSpecificKids';


const SpecificKids = () => {
    const {id17} = useParams();
    const[item,error,loading] = useSpecificKids(id17);
      ...
      <div className="specific-item-container trending-container">
        ...
        <div className="right-section">
          ...
          <div className="action-buttons">
            <button onClick={() => addKids(item)} className="add-to-cart-btn">
              Add to Cart
            </button>
