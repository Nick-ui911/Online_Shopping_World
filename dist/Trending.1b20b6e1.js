...
},{"f11b6b8f6a1f6f0b":"786KC","f490fb404efab291":"1dldy"}],"dGgvd":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "4bb492f41b20b6e1";
"use strict";
...
},{}],"5Qdva":[function(require,module,exports,__globalThis) {
...
var _useTrending = require("../utils/useTrending");
var _useTrendingDefault = parcelHelpers.interopDefault(_useTrending);
var _s = $RefreshSig$();
const Trending = ()=>{
    _s();
    const [trending, setTrending, searchTrending, loading, error] = (0, _useTrendingDefault.default)();
    const [searchTxt, setSearchTxt] = (0, _react.useState)("");
    const handleSearch = ()=>{
        if (searchTxt.trim() === "") setTrending(searchTrending);
        else {
            const filteredData = (0, _helper.filterData)(searchTxt, searchTrending);
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                        className: "search-button btn btn-outline-primary col-md-auto",
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                ...
                children: trending.length === 0 ? /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                    children: "No trending items found."
                }, void 0, false, {
                    fileName: "src/component/Trending.js",
                    lineNumber: 78,
                    columnNumber: 11
                }, undefined) : trending.map((item)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _reactRouterDom.Link), {
...
_s(Trending, "RU7ZP+8a7dyblCm6nAEkd/B1jGE=", false, function() {
    return [
        (0, _useTrendingDefault.default)
    ];
});
_c = Trending;
...
},{"react/jsx-dev-runtime":"iTorj","./shimmer":"bltIQ","react":"21dqq","react-router-dom":"9xmpe","../utils/helper":"3GF3D","../utils/useTrending":"hfTnY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}],"3GF3D":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hfTnY":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$9fdd = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$9fdd.prelude(module);
...
const useTrending = ()=>{
    ...
    const [searchTrending, setSearchTrending] = (0, _react.useState)([]);
    ...
    async function TrendingItem() {
        setLoading(true);
        try {
            const response = await fetch((0, _constants.T_R_N));
...
_s(useTrending, "TACB9ZkRBZ9DK5ne0R0ZIuwXX+k=");
exports.default = useTrending;

  $parcel$ReactRefreshHelpers$9fdd.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aQL8O","dGgvd"], null, "parcelRequire94c2")

//# sourceMappingURL=Trending.1b20b6e1.js.map
